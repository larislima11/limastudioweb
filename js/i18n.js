...
const I18N = {
  ...
  pt: {
    ...
    hero_lead: "Crio sites modernos, rápidos e fáceis de achar, feitos sob medida para o seu negócio atrair mais clientes e passar credibilidade já no primeiro clique.",
    ...
    c1p: "Sua vitrine digital aberta 24h, passando confiança e aparecendo quando procuram pelo seu serviço.",
    c2h: "Lojas online",
  ...
  en: {
    ...
    hero_lead: "I build modern, fast, easy-to-find websites, made to measure so your business attracts more customers and earns trust from the very first click.",
    ...
    c1p: "Your digital storefront open 24/7, building trust and showing up when people search for your service.",
    c2h: "Online stores",
  ...
  es: {
    ...
    hero_lead: "Creo sitios web modernos, rápidos y fáciles de encontrar, hechos a medida para que tu negocio atraiga más clientes y transmita credibilidad desde el primer clic.",
    ...
    c1p: "Tu vitrina digital abierta 24h, que transmite confianza y aparece cuando buscan tu servicio.",
    c2h: "Tiendas online",
